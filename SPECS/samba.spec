...
Patch36: samba-4.1.14-nsswitch-skip_unmapped_groups.patch
...
%patch36 -p1 -b .samba-4.1.14-nsswitch-skip_unmapped_groups.patch
...
%changelog
* Mon Feb 23 2015 - Simon Li <spli@dundee.ac.uk> - 4.1.1-38.1
- Patch to handle unmapped windbind groups
